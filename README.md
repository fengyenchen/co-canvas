...
「下載完整分析包」會產生 ZIP，內容包括清理後事件、參與者／條件／時間／序列摘要、資料品質報告、分析設定、統計結果、HTML 報告、SVG 圖表、欄位字典及 Python／R 範例；另可個別下載摘要 CSV、HTML 或 SVG／PNG 圖表。這些結果仍須搭配研究設計、任務表現、問卷或訪談解讀，正式推論建議用專業統計軟體複核。
